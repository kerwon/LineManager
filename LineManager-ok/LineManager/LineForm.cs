...
namespace LineManager
{
    public partial class LineForm : Form
    {
        ...
        private async void btnUpdateExcel_Click(object sender, EventArgs e)
        {
            ...
            if (dialog == DialogResult.OK)
            {
                ...
                //var result1 = await ExcelHelper.ReadKuCunInfosExcel(KuCunFilePath);
                // FillDataInfos(result1, this.dgvKuCunInfo);
                //this.KuCunInfoList = KuCunInfo.MapCunInfos(result1);

                //var result2 = await ExcelHelper.ReadFaHuoInfosExcel(KuCunFilePath);
                // FillDataInfos(result2, this.dgvFaHuoTaskInfo);
                //FaHuoTaskItemList = FaHuoTaskItem.MapTaskItems(result2);
        ...
        /// <param name="e"></param>
        private async void btnKcInfo_Click(object sender, EventArgs e)
        {
            var dialog = this.ofdKcExcel.ShowDialog();
        ...
        private  async Task CheckExecResult()
        {
            ...
            var result =  await Task.Run(() => CalcResultInfo2.Calc(this.KuCunInfoList, this.FaHuoTaskItemList, condition));
